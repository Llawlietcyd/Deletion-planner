...
WEEKDAY_PATTERNS = [
    (0, [r"每周一", r"星期一", r"周一", r"礼拜一", r"\bmonday\b", r"\bmon\b"]),
    (1, [r"每周二", r"星期二", r"周二", r"礼拜二", r"\btuesday\b", r"\btue\b", r"\btues\b"]),
    (2, [r"每周三", r"星期三", r"周三", r"礼拜三", r"\bwednesday\b", r"\bwed\b"]),
    (3, [r"每周四", r"星期四", r"周四", r"礼拜四", r"\bthursday\b", r"\bthu\b", r"\bthur\b", r"\bthurs\b"]),
    (4, [r"每周五", r"星期五", r"周五", r"礼拜五", r"\bfriday\b", r"\bfri\b"]),
    (5, [r"每周六", r"星期六", r"周六", r"礼拜六", r"\bsaturday\b", r"\bsat\b"]),
    (6, [r"每周日", r"每周天", r"星期日", r"星期天", r"周日", r"周天", r"礼拜日", r"礼拜天", r"\bsunday\b", r"\bsun\b"]),
]
